...
| `bootstrap.backoffLimit`                                 | Specifies the number of retries before marking this job failed                                                                              | `3`                         |
...
| `common.remoteParticipants[0].name`                           | Participant name                                                                                                                                                                   | `participant1`                                                                       |
| `common.remoteParticipants[0].host`                           | Participant hostname                                                                                                                                                               | `participant1`                                                                       |
| `common.remoteParticipants[0].ports.public`                   | Participant Ledger API port (gRPC)                                                                                                                                                 | `4001`                                                                               |
| `common.remoteParticipants[0].ports.admin`                    | Participant admin port (gRPC)                                                                                                                                                      | `4002`                                                                               |
| `common.remoteParticipants[0].tls`                            | Participant TLS configuration                                                                                                                                                      |                                                                                      |
| `common.remoteParticipants[0].tls.public.enabled`             | Enabled mTLS for Ledger API traffic                                                                                                                                                | `false`                                                                              |
| `common.remoteParticipants[0].tls.public.trustCollectionFile` | CA certificate                                                                                                                                                                     | `/mtls/ca.crt`                                                                       |
| `common.remoteParticipants[0].tls.public.certChainFile`       | Certificate                                                                                                                                                                        | `/mtls/tls.crt`                                                                      |
| `common.remoteParticipants[0].tls.public.privateKeyFile`      | Certificate key (PKCS-8)                                                                                                                                                           | `/mtls/tls.key`                                                                      |
| `common.remoteParticipants[0].tls.admin.enabled`              | Enabled mTLS for admin API traffic                                                                                                                                                 | `false`                                                                              |
| `common.remoteParticipants[0].tls.admin.trustCollectionFile`  | CA certificate                                                                                                                                                                     | `/mtls/ca.crt`                                                                       |
| `common.remoteParticipants[0].tls.admin.certChainFile`        | Certificate                                                                                                                                                                        | `/mtls/tls.crt`                                                                      |
| `common.remoteParticipants[0].tls.admin.privateKeyFile`       | Certificate key (PKCS-8)                                                                                                                                                           | `/mtls/tls.key`                                                                      |

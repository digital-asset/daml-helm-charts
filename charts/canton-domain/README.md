...
| `common.tls.public.certManager.fsGroup`          | Cert-manager FS Group of mounted files, should be paired with and match container `runAsGroup`                                                                   | `65532`                                                                              |
...
| `common.tls.admin.certManager.fsGroup`           | Cert-manager FS Group of mounted files, should be paired with and match container `runAsGroup`                                                                   | `65532`                                                                              |
...
| `common.mtls.admin.certManager.fsGroup`          | Cert-manager FS Group of mounted files, should be paired with and match container `runAsGroup`                                                                   | `65532`                                                                              |
...
| `testing.bootstrap.remoteParticipants[*].tls.admin.certManager.issuerGroup`  | Cert-Manager issuer group. Allowed values: `cert-manager.io`, `cas-issuer.jetstack.io`, `cert-manager.k8s.cloudflare.com`, etc.                                                    |       |
| `testing.bootstrap.remoteParticipants[*].tls.admin.certManager.issuerKind`   | Cert-Manager issuer kind. Allowed values: `Issuer`, `ClusterIssuer`, `GoogleCASIssuer`, `OriginIssuer`, etc.                                                                       |       |
| `testing.bootstrap.remoteParticipants[*].tls.admin.certManager.issuerName`   | Cert-manager issuer name                                                                                                                                                           |       |
| `testing.bootstrap.remoteParticipants[*].tls.admin.certManager.fsGroup`      | Cert-manager FS Group of mounted files, should be paired with and match container `runAsGroup`                                                                                     |       |
...
| `testing.bootstrap.remoteParticipants[*].mtls.admin.certManager.issuerGroup` | Cert-Manager issuer group. Allowed values: `cert-manager.io`, `cas-issuer.jetstack.io`, `cert-manager.k8s.cloudflare.com`, etc.                                                    |       |
| `testing.bootstrap.remoteParticipants[*].mtls.admin.certManager.issuerKind`  | Cert-Manager issuer kind. Allowed values: `Issuer`, `ClusterIssuer`, `GoogleCASIssuer`, `OriginIssuer`, etc.                                                                       |       |
| `testing.bootstrap.remoteParticipants[*].mtls.admin.certManager.issuerName`  | Cert-manager issuer name                                                                                                                                                           |       |
| `testing.bootstrap.remoteParticipants[*].mtls.admin.certManager.fsGroup`     | Cert-manager FS Group of mounted files, should be paired with and match container `runAsGroup`                                                                                     |       |

...
for chart in $CHARTS_DIR/*; do
    ...
    if helm search repo $GITREPO_NAME/$chart_name -o yaml  -l | grep -w "version: $chart_version"; then
        ...
        helm repo index publish --url https://github.com/$GITREPO_OWNER/$GITREPO_NAME/releases/download/$chart_name-$chart_version/$chart_name-$chart_version  --merge docs/index.yaml
